...
"""
        ...
        if not records:
            return {
                'period_days': days
                'metric': metric or 'quality_score','data_points': 0,'trend': 'no_data','current_average': 0.0,'previous_average': 0.0,'change_percentage': 0.0,'timeline': []
            }
        ...
        return {
            'period_days': days
            'metric': metric or 'quality_score','data_points': len(values)
            'trend': trend
