    ...
    if patterns_dir.exists():
        ...
        if patterns_file.exists():
            try:
                ...
                print(f"✅ patterns.json loaded: {len(patterns_data.get('patterns', []))} patterns")
                ...
                print(f"❌ Error loading patterns.json: {e}")
        else:
        ...
        if perf_file.exists():
            try:
                ...
                print(f"✅ performance_records.json loaded: {len(perf_data.get('records', []))} records")
            except Exception as e:
                print(f"❌ Error loading performance_records.json: {e}")
        ...
        if skill_file.exists():
            try:
                ...
                print(f"✅ skill_metrics.json loaded: {list(skill_data.keys())}")
            except Exception as e:
                print(f"❌ Error loading skill_metrics.json: {e}")
        ...
        if unified_file.exists():
            try:
                ...
                print(f"✅ unified_data.json loaded: {list(unified_data.keys())}")
            except Exception as e:
                print(f"❌ Error loading unified_data.json: {e}")
