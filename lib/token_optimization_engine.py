...
class TokenOptimizer:
    ...
    def register_content(self, path: str, content: str, content_type: ContentType,
                        priority: int = 5, dependencies: List[str] = None) -> None:
    ...
    def get_optimized_content_set(self, content_type: ContentType,
                                 max_total_tokens: int = None) -> Dict[str, str]:
        ...
        filtered_content = [
            (path, item) for path, item in self.content_registry.items()
