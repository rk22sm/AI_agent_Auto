...
class EnhancedPatternPredictor:
    ...
    def _ensure_files(self):
        ...
        if not self.predictions_file.exists():
            self._write_json(self.predictions_file, {
                "version": "2.0.0",
    ...
    def record_prediction_result(self, task_context: Dict[str, Any],
        ...
        # Calculate accuracy
        skill_accuracy = len(set(predicted_skills) & set(actual_skills)) / len(set(predicted_skills) | set(actual_skills)) if predicted_skills or actual_skills else 1.0
        agent_accuracy = len(set(predicted_agents) & set(actual_agents)) / len(set(predicted_agents) | set(actual_agents)) if predicted_agents or actual_agents else 1.0
...
def main():
    ...
    parser.add_argument('--action', choices=['predict', 'train', 'accuracy', 'init'],
