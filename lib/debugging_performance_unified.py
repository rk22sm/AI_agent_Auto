...
class DebuggingPerformanceProvider:
                ...
                if capture_debugging_pattern and len(debugging_tasks) > 0:
                    try:
                        ...
                        task_context = {
                            ...
                            "duration_minutes": sum(task.get('details', {}).get('duration_seconds', 0) for task in debugging_tasks) / 60 / len(debugging_tasks)
                        }
    ...
    def _calculate_debugging_performance_metrics(self, debugging_tasks: List[Dict], current_model: str) -> Dict[str, Any]:
        ...
        initial_qualities = [task.get('details', {}).get('initial_quality', task.get('overall_score', 0)) for task in debugging_tasks]
    ...
    def _format_debugging_assessment(self, task: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "breakdown": task.get("details", {}).get("breakdown", {
                "tests_passing": 25,
