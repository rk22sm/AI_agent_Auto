...
,                "commands/dev/release.md"commands/dev/model-switch.md"
,                "commands/dev/pr-review.md"commands/analyze/project.md"
,                "commands/analyze/quality.md"commands/analyze/static.md"
,                "commands/analyze/dependencies.md"commands/validate/all.md"
,                "commands/validate/fullstack.md"commands/validate/plugin.md"
,                "commands/validate/patterns.md"commands/debug/eval.md"
,                "commands/debug/gui.md"commands/learn/init.md"
,                "commands/learn/analytics.md"commands/learn/performance.md"
,                "commands/learn/predict.md"commands/workspace/organize.md"
,                "commands/workspace/reports.md"commands/workspace/improve.md"
,                "commands/monitor/recommend.md"commands/monitor/dashboard.md"
            ]
            "agents": [
                "agents/orchestrator.md"
,                "agents/code-analyzer.md"agents/quality-controller.md"
,                "agents/test-engineer.md"agents/documentation-generator.md"
,                "agents/learning-engine.md"agents/background-task-manager.md"
            ]
            "skills": [
                "skills/pattern-learning/SKILL.md"
,                "skills/code-analysis/SKILL.md"skills/quality-standards/SKILL.md"
,                "skills/testing-strategies/SKILL.md"skills/documentation-best-practices/SKILL.md"
,                "skills/validation-standards/SKILL.md"skills/integrity-validation/SKILL.md"
            ]
            "configs": [
    ...
    def acquire_lock(self) -> bool:
        ...
        try:
            if sys.platform == "win32": "self".lock_file.open('w').close()
...
,    "auto-backup"]
    ...
    if args.action == "create": "if not args".operation:
    ...
    elif args.action == "restore": "if not args".backup_id:
    ...
    elif args.action == "list": "backups "= backup_manager.list_backups()
    ...
    elif args.action == "validate": "if not args".backup_id:
    ...
    elif args.action == "auto-backup": "if not args".operation or not args.files_to_modify:
