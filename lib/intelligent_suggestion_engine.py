...
class SuggestionTemplate:
    ...
    def __init__(self, template_id: str, category: str, priority: str,
                 description_template: str, command_template: str,
                 conditions: Dict[str, Any], weights: Dict[str, float]):
...
class IntelligentSuggestionEngine:
        ...
        if self.templates_file.exists():
            try:
                with open(self.templates_file, 'r', encoding='utf-8') as f:
                    data = json.load(f)
                    self.templates = [
                        SuggestionTemplate(**t) for t in data.get('templates', [])
                    ]
            except Exception as e:
    ...
    def _load_default_templates(self):
        ...
        default_templates = [
            # Quality improvement templates
            {
                ...
                'conditions': {
                    ...
                    'exclude_if_recent': ['/analyze:quality']
                },
            ...
            # Documentation templates
            {
                ...
                'conditions': {
                    'project_types': ['unknown', 'prototype'],
                    'exclude_if_recent': ['/dev:auto']
                },
            ...
            # Learning templates
            {
                ...
                'conditions': {
                    'exclude_if_recent': ['/learn:analytics'],
                    'base_time': 2
                },
        ...
        self.templates = [
            SuggestionTemplate(**template) for template in default_templates
        ]
    ...
    def _calculate_suggestion_score(self, suggestion: Dict[str, Any], context: SuggestionContext) -> float:
        ...
        if self.preference_memory:
            ...
            if suggestion.get('category') == 'quality_improvement' and context.quality_score and context.quality_score < pref_quality_threshold:
                score += 0.1
    ...
    def _filter_suggestions(
        self,
        scored_suggestions: List[Tuple[Dict[str, Any], float]],
        context: SuggestionContext
    ) -> List[Dict[str, Any]]:
        ...
        for suggestion, score in scored_suggestions:
            ...
            if suggestion.get('risks') and context.quality_score and context.quality_score < 50:
                high_risk = any('destructive' in risk.lower() or 'critical' in risk.lower() for risk in suggestion.get('risks'))
                if high_risk:
                    continue
    ...
    def _update_generation_analytics(self, suggestions: List[Dict[str, Any]], context: SuggestionContext):
        ...
        for suggestion in suggestions:
            ...
            if category not in self.analytics['category_effectiveness']:
                self.analytics['category_effectiveness'][category] = {
                    'generated': 0,
                    'accepted': 0,
                    'success_rate': 0.0
                }
    ...
    def get_suggestion_analytics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'most_effective_categories': sorted(
                self.analytics['category_effectiveness'].items(),
    ...
    def create_custom_template(
        ...
        new_template = SuggestionTemplate(
            template_id, category, priority,
            description_template, command_template,
            conditions, weights
        )
        ...
        if args.action == 'generate':
            ...
            if args.template_action == 'list':
                ...
                success = engine.create_custom_template(
                    args.id, args.category, args.priority,
