...
```bash
/pr-review [PR_NUMBER|BRANCH_NAME]
```

**Examples**:
```bash
/pr-review 123              # Review PR #123
/pr-review feature/auth     # Review branch against main
...
/pr-review-history              # Show review history
/pr-review-analytics            # Review performance analytics
```
